...
namespace prjMinhaEmpresa
{
    public partial class frmCadProduto : Form
    {
            ...
            if (e.KeyCode == Keys.Enter) //faz o tab virar enter
            {
                ...
                finally
                {
                    ...
                    { //libera os campos
                        ...
                        toolStripStatusMSG.Text = "Digite as informações do produto <Enter>";
                    }
                    else
                    {
                        while (dr.Read())
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            ...
            {
                dr.Close();
                strSQL = "INSERT INTO tb_produtos SET Prod_Codigo=@parCodigo, Prod_Descricao=@parDesc, Prod_Qtd_Estoq=@parQtdEstoque, Prod_Estoq_Min=@parEstoqueMin, Prod_Unidade=@parUnidade, Prod_Locacao=@parLocacao,";
